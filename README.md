...
**Mestogram** is a photo sharing app similar to Instagram but using Parse as its backend.
...
- [x] App has Instagram logo and colors
- [x] User can navigate to logout screen by clicking the profile icon
- [x] User can navigate to timeline screen by clicking the home icon
...
## Notes
- Keeping track with all the activities and views.
